    ...
    <section>
      <div id="content" class="content">
        <div class="content-header">
            <h1>Add Transportation Office</h1>
            <ul class="breadcrumb">
                <li><a href="index.php"><i class="fas fa-bus"></i> Home</a></li>
                <li><a href="#">Transportation Office</a></li>
                <li>Add Transportation Office</li>
            </ul>
        </div>
        ...
        <div class="content-form">
          <form action="addofficeprocess.php" method="post" name="containerform">
            <div class="form-header">
              <h1>Transportation Office Details</h1>
            </div>
            <hr>
            <div class="form-box">
                <div class="row">
                  ...
                  <div class="col-50" style="padding-left: 10px;">
                      ...
                      <input class="input" type="text" name="officename" id="officename" placeholder="Office Name" required />
                  </div>
                  <div class="col-50">
                      <label>Email</label>
                  ...
                  <div class="col-50" style="padding-left: 10px;">
                      ...
                      <input class="input" type="number" name="contactno" id="contactno" placeholder="Contact Number" required />
                  </div>
                  <div class="col-50">
                      <label>Location</label>
                      <input class="input" type="text" name="location" id="location" placeholder="Location" autocomplete="off" required />
                  </div>
                  <div class="col-50"  style="padding-left: 10px;">
                      <label>Country</label>
                  ...
                  <div class="col-50">
                      <button type="submit" name="submitOffice">Submit</button>
                  </div>
                </div>
