            ...
            <div class="form-box">
                <div class="row">
                  ...
                  <div class="col-50">
                      ...
                      <input class="input" type="text" name="departureport" id="departureport" placeholder="Departure Port" required/>
                  </div>
                  <div class="col-50" style="padding-left: 10px;">
                      <label>Arrival Port</label>
                      <input class="input" type="text" name="arrivalport" id="arrivalport" placeholder="Arrival Port" required />
                  </div>
                  <div class="col-50">
                      <label>Date</label>
                      <input style="height: 36px;" class="input" type="date" name="date" id="date" required/>
                  </div>
                  <div class="col-50" style="padding-left: 10px;">
                      <label>Time</label>
                      <input style="height: 36px;" class="input" type="time" name="time" id="time" required />
                  </div>
                  <div class="col-50">
                      <button type="submit" name="submitRoute">Submit</button>
                  </div>
                </div>
            </div>
          </form>
